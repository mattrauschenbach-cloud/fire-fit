...
import ExportData from './pages/Export.jsx'
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 max-w-6xl w-full mx-auto p-4">
        <Routes>
          ...
          <Route path="/export" element={<ProtectedRoute><MentorRoute><ExportData /></MentorRoute></ProtectedRoute>} />
          <Route path="*" element={<Navigate to="/" replace />} />
        </Routes>
      </main>
      <footer className="py-6 text-center text-sm text-slate-500">Station 1 Fit Garfield Heights • Built for the crew</footer>
    </div>
  )
}
